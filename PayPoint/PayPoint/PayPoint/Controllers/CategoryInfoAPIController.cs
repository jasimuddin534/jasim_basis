...
{
    [Authorize]
    public class CategoryInfoAPIController : ApiController
    {
        private PayPointContext db = new PayPointContext();

        // GET api/CategoryInfoAPI
        public IEnumerable<Category> GetCategories()
        {
            return db.Categories.AsEnumerable();
        }

        // GET api/CategoryInfoAPI/5
